...
app.use((req, res, next) => {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'Content-Type, Authorization, Accept, x-monetag-key');
...
apiRouter.get('/', (req, res) => {
  res.json({ status: 'ok', service: 'monetag-api' });
});
...
// Mount API router strictly under /api so root paths are handled by Vite / static frontend
