...
export default function DailyStatsTable({ stats }: DailyStatsTableProps) {
  ...
  return (
    <div id="daily-stats-table-container" className="bg-white dark:bg-black rounded-lg border border-slate-200 dark:border-neutral-800 overflow-hidden transition-colors">
      {/* Controls */}
      <div className="px-3.5 py-2.5 border-b border-slate-200 dark:border-neutral-800 flex items-center justify-between gap-3 text-xs">
        <input
          ...
          className="bg-transparent border border-slate-200 dark:border-neutral-800 rounded px-2 py-1 text-slate-800 dark:text-neutral-200 placeholder-slate-400 dark:placeholder-neutral-600 focus:outline-none focus:border-slate-400 dark:focus:border-neutral-600 w-44 font-mono text-xs"
        />
