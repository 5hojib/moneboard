  ...
  if (isInstallable) {
    return (
      <button
        ...
        className="h-7 px-2.5 inline-flex items-center gap-1.5 justify-center text-xs leading-none text-slate-700 dark:text-neutral-300 bg-slate-100 dark:bg-neutral-900 hover:bg-slate-200 dark:hover:bg-neutral-800 rounded border border-slate-200 dark:border-neutral-700 transition-colors cursor-pointer font-medium select-none"
      >
