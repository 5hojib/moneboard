...
export default function SettingsPage() {
  ...
  return (
    <div id="settings-page" className="space-y-4">
      ...
      <section className="bg-white dark:bg-black rounded-lg border border-slate-200 dark:border-neutral-800 transition-colors">
      ...
      <section className="bg-white dark:bg-black rounded-lg border border-slate-200 dark:border-neutral-800 transition-colors">
        ...
        <div className="px-4 py-3">
          <div id="theme-switcher" className="h-10 flex items-center bg-slate-100 dark:bg-neutral-900 p-0.5 rounded-lg border border-slate-200 dark:border-neutral-800 text-xs">
            {themes.map((t) => {
              const Icon = t.icon;
